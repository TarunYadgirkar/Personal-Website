...
export const metadata: Metadata = {
  title: "About",
  description: "Tarun Yadgirkar builds where hardware meets AI, from FPGAs to AR glasses, and studies applied mathematics at UC Berkeley. What drives the work, and how to reach him.",
};
...
const paragraphs = [
  ...
  "I explore widely on purpose. I build at hackathons most months, usually voice-first applied AI, and I keep the prototypes running afterward so strangers can use them and tell me what breaks. I study applied mathematics at UC Berkeley, which underlies every one of these projects.",
  ...
  return (
    <Page title="About">
      <div className="grid gap-10 md:grid-cols-[1fr_320px] md:gap-16">
        ...
        <figure className="order-first md:order-none md:-mt-24">
